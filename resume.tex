...
Web: &                  Emscripten, HTML5/CSS/JS, React.js, Electron, RESTful design\\[4pt]
...
\textbf{\textsc{Amazon}} \hfill Cambridge, MA\\
\vspace{2mm}

\begin{addmargin}[1em]{0em}
    \textit{Seniot Software Engineer} \hfill September 2018 - Present\\
    \vspace{-1mm}
    \begin{itemize} \itemsep 1pt
        ...
        \begin{itemize}
            \item Build out all motor/motion features, safety features, motion policies, vision and audio integrations.
